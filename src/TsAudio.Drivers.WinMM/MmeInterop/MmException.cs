...
namespace TsAudio.Drivers.WinMM.MmeInterop
{
    ...
    public class MmException : Exception
    {
        ...
        public static void TryExecute(Func<MmResult> func, object waveOutLock, string function)
        {
            MmResult result;
        ...
        public static void TryExecute(Func<MmResult> func, string function)
        {
            MmResult result = func();
